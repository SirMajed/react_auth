    ...
    return (
        ...
        <div className="mt-20">
            ...
            <div className="px-5 mt-5">
                ...
                <Link to="#" className="font-semibold text-gray-700 pt-1">Forgot password?</Link>
                </div>
            </div>
            </div>
            <p className="text-lg font-light text-center mb-5 mt-3">Dont have an account? 
            <Link to="/register" className="font-normal text-gray-700 ml-1 underline">Create new account</Link>
            </p>
        </div>
        </>
    );
